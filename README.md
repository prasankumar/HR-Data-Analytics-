...
1) Created HR metrics like headcount, Average leave balance, Average salary etc. with Power Pivot

2) Adding columns to the data (like Employee's first name, age group etc.)

3) Finding relationships between salary and education qualification

4) Using visual filters to see top / bottom paid staff in each job
...
7) Designing a monthly HR dashboard with Power BI

8) Working with "NEW" card visual in Power BI
